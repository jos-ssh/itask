...
QEMUOPTS += -device virtio-net-pci,netdev=vmnic -netdev user,id=vmnic,hostfwd=tcp::2222-:22
# For Wireshark tests
QEMUOPTS += -object filter-dump,id=id,netdev=vmnic,file=netdump.pcap,maxlen=1000000000
