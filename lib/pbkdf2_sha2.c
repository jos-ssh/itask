...
static void
sha2_process(sha2_context *ctx, const unsigned char data[64]) {
 ...
 */
void
sha2_update(sha2_context *ctx, const unsigned char *input, size_t ilen) {
    size_t fill;
    unsigned long left;
 ...
 */
void
sha2(const unsigned char *input, size_t ilen,
 ...
 */
void
sha2_hmac_starts(sha2_context *ctx, const unsigned char *key, size_t keylen,
                 int is224) {
    size_t i;
 ...
 */
void
sha2_hmac_update(sha2_context *ctx, const unsigned char *input, size_t ilen) {
    sha2_update(ctx, input, ilen);
}
 ...
 */
void
sha2_hmac(const unsigned char *key, size_t keylen,
...
void
PKCS5_PBKDF2_HMAC(const unsigned char *password, size_t plen,
